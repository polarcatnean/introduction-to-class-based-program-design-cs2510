...
interface ILoString {
  ...
  // reversed list is still the same list
  boolean isPalindromeList();
  
  boolean isSameList(ILoString other);
  boolean isSameListHelper(String first, ILoString rest);
...
class MtLoString implements ILoString {
  ...
  public boolean isDoubledListHelper(String acc) {
    // for odd number of element list
    return false;
  }
  ...
  public boolean isSameList(ILoString other) {
  ...
  public boolean isSameListHelper(String first, ILoString rest) {
    return false;
  }
...
class ConsLoString implements ILoString {
  ...
  public boolean isPalindromeList() {
    // TODO Auto-generated method stub
    return this.isSameList(this.reverse());
  }

  public boolean isSameList(ILoString reverse) {
    // TODO Auto-generated method stub
    return reverse.isSameListHelper(this.first, this.rest);
  }

  public boolean isSameListHelper(String otherFirst, ILoString otherRest) {
    // TODO Auto-generated method stub
    if (otherFirst.equals(this.first)) {
      return otherRest.isSameList(this.rest);
    }
    return false;
  }
...
class ExamplesStrings {
  ...
  ILoString dList3 = new ConsLoString("1", new ConsLoString("1", new ConsLoString("2", new ConsLoString("4", 
      new ConsLoString("3", new ConsLoString("3", new MtLoString()))))));
  ILoString dList4 = new ConsLoString("a", new ConsLoString("a", new ConsLoString("a", new ConsLoString("a", new MtLoString()))));
  
  // for palindrome list
  ILoString p1 = new ConsLoString("a", new ConsLoString("b", new ConsLoString("a", new MtLoString())));
  ILoString p2 = new ConsLoString("a", new ConsLoString("b", new ConsLoString("b", new ConsLoString("a", new MtLoString()))));
  ILoString p3 = new ConsLoString("a", new ConsLoString("b", new ConsLoString("c", new ConsLoString("d", new ConsLoString("a", new MtLoString())))));
  ILoString p4 = new ConsLoString("a", new ConsLoString("b", new ConsLoString("c", new ConsLoString("a", new MtLoString()))));
  ...
  boolean testReverse(Tester t) {
    return t.checkExpect(new MtLoString().reverse(), new MtLoString())
        && t.checkExpect(new ConsLoString("a", new MtLoString()).reverse(), new ConsLoString("a", new MtLoString()))
  ...
  boolean testIsDoubledList(Tester t) {
    return t.checkExpect(new MtLoString().isDoubledList(), true)
        ...
        && t.checkExpect(new ConsLoString("a", new MtLoString()).isDoubledList(), false)  // single element list
        && t.checkExpect(dList4.isDoubledList(), true);  // all elements identical
  }
  
  boolean testIsPalindromeList(Tester t) {
    return t.checkExpect(new MtLoString().isPalindromeList(), true)
        && t.checkExpect(new ConsLoString("a", new MtLoString()).isPalindromeList(), true)  // single element
        && t.checkExpect(mary.isPalindromeList(), false)  // invalid palindrome list
        && t.checkExpect(p1.isPalindromeList(), true)     // valid palindrome list (odd)
        && t.checkExpect(p2.isPalindromeList(), true)     // valid palindrome list (even)
        && t.checkExpect(p3.isPalindromeList(), false)    // invalid odd
        && t.checkExpect(p4.isPalindromeList(), false);   // invalid even
  }
}