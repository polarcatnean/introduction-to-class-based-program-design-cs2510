...
class RiverSystemExample {
  ...
  ILoLoc list1 = new ConsLoc(lt, new ConsLoc(ls, empty));
  ILoLoc list2 = new ConsLoc(la, new ConsLoc(lb, empty));
  ILoLoc list3 = new ConsLoc(la, new ConsLoc(lb, new ConsLoc(lt, new ConsLoc(ls, empty))));
  ...
  boolean testAppend(Tester t) {
    return t.checkExpect(empty.append(new ConsLoc(ls, empty)), new ConsLoc(ls, empty))
        && t.checkExpect(new ConsLoc(lt, empty).append(new ConsLoc(ls, empty)), list1)
        && t.checkExpect(list2.append(list1), list3);
  }
}