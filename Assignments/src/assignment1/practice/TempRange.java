...
class TempRange {
  ...
  TempRange(Date d, TemperatureRange today, TemperatureRange normal, TemperatureRange record,
      double precipitation) {
    this.d = d;
    this.today = today;
    this.normal = normal;
...
class RangeExamples {
  ...
  TempRange r1 = new TempRange(d1, tr1, tr2, tr3, 0);
  TempRange r2 = new TempRange(d2, tr2, tr3, tr1, 10);
  TempRange r3 = new TempRange(d3, tr3, tr1, tr2, 9);
  TempRange r4 = new TempRange(d4, tr1, tr4, tr3, 20);
  TempRange r5 = new TempRange(d4, tr1, tr3, tr4, 20);
