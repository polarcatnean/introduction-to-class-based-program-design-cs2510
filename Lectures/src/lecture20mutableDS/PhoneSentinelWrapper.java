...
class MutableLoPerson implements IMutableLoPerson {
  ...
  MutableLoPerson(ILoPerson list) {
    sentinel = new Sentinel(list);  // set default sentinel to point to an empty list
  }
...
class MtLoPerson implements ILoPerson {
  ...
  public void addToFrontHelper(String name, int phone, AListPerson prev) {
    prev.rest = new ConsLoPerson(new Person(name, phone), this);
...
class ExamplePhoneLists {
  ...
  void testAddToFront(Tester t) {
    ...
    MutableLoPerson list3 = new MutableLoPerson(new ConsLoPerson(new Person("Anne", 1234), new MtLoPerson()));
    list3.addToFront("Nean", 7777); 
    t.checkExpect(list3.contains("Nean"), true);
    t.checkExpect(list3.sentinel, new Sentinel(new ConsLoPerson(new Person("Nean", 7777),
                                      new ConsLoPerson(new Person("Anne", 1234), new MtLoPerson()))));
  }
