...
public class Examples {
  ...
  void testWithdrawAccount(Tester t) {
    ...
    t.checkException(new RuntimeException("Account number not found."), bank1, "withdraw", 50, 3);
    t.checkException(new RuntimeException("100 is not available"), bank1, "withdraw", 100, 1);
  }
  ...
  void testDepositAccount(Tester t) {
    ...
    t.checkException(new RuntimeException("Account number not found."), bank1, "deposit", 50, 3);
  }
